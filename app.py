...
# Create Flask app
app = Flask(__name__)
app.secret_key = os.environ.get("SESSION_SECRET", "your-very-secret-key-123456")

# 优化会话配置
from datetime import timedelta
app.config['PERMANENT_SESSION_LIFETIME'] = timedelta(days=7)  # 会话持续7天
app.config['SESSION_COOKIE_SECURE'] = False  # 使用HTTPS
...
if __name__ == "__main__":
    with app.app_context():
        ...
        # 导入模型和路由
        from models import User, audit_logger  # noqa: F401
